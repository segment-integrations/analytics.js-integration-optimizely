...
Optimizely.prototype.sendClassicDataToSegment = function(experimentState) {
  ...
  // Refomarting this data structure into hash map so concatenating variation ids and names is easier later
  ...
  if (this.options.variations) {
    ...
    var traits = {};
    traits['Experiment: ' + experiment.name] = variationNames; // eg. 'Variation X' or 'Variation 1, Variation 2'
