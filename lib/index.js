 ...
 * @param {Object} experimentState.section: the section for the variations (only defined for multivariate experiments)
 * @param {Object} experimentState.section.name: the name of section
 * @param {Object} experimentState.section: the ID of the section
 *
 */
...
Optimizely.prototype.sendClassicDataToSegment = function(experimentState) {
  ...
  var section = experimentState.section;
  var variationNames = [];
  ...
  if (this.options.listen) {
    ...
    if (variations.length > 1) {
      ...
      if (section) {
        props.sectionName = section.name; // "grouping" of variations
        props.variationId = section.variation_ids.join(); // eg '1,22,3709'
      }
    }
